...
skills = [
  ...
  ("riding","Riding",sf_base_att_agi,10,"Enables you to ride horses of higher difficulty levels and increases your riding speed and manuever. Reduces melee damage to you and your horse by 4%% per skill level when you are on horse.  (Personal skill) Max level: 10"),
  ("athletics","Athletics",sf_base_att_agi,10,"Improves your running speed. Reduces melee damage to you by 4%% per skill level when you are on foot. (Personal skill)"),
  ("shield","Lefthand",sf_base_att_agi,10,"Reduces damage to shields (by 8%% per skill level) and improves shield speed and coverage. Increases bow damage and melee damage when two-handed (by 4%% per skill level). (Personal skill) Max level: 10"),
  ...
  ("ironflesh","Ironflesh",sf_base_att_str,15,"Each point to this skill increases hit points by +2. Reduces 1 damage to you every two levels. For soldiers, each point to this skill gives a 3%% chance to be wounded rather than killed by a mortally struck. (Personal skill) Max level: 15"), 
