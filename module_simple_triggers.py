...
simple_triggers = [
    ...
    (48,
     [
         ...
         # ## CC
         # (try_end),
         (store_sub, ":num_hiring_rounds", 3, ":reduce_campaign_ai"),
         ## CC
         (try_end),
         (try_for_range, ":unused", 0, ":num_hiring_rounds"),
         # (party_get_slot, ":cur_wealth", ":center_no", slot_town_wealth),
         ...
         (call_script, "script_get_reinforce_party_template", ":center_no"),
         (assign, ":party_template", reg0),
         (gt, ":party_template", 0),
         (party_clear, "p_temp_party"),
         (party_add_template, "p_temp_party", ":party_template"),
         (call_script, "script_get_party_join_cost", "p_temp_party"),
         (assign, ":reinforcement_cost", reg0),
         (party_get_slot, ":cur_wealth", ":center_no", slot_town_wealth),
         (assign, ":hiring_budget", ":cur_wealth"),
         (val_div, ":hiring_budget", 2),
         (gt, ":hiring_budget", ":reinforcement_cost"),
    ...
    (0.5,
     [
         ...
         (try_begin),
             ...
             (neq, ":original_faction", "fac_outlaws"),  # outlaws don't change relations with you
    ...
    (7 * 24,
     [
         (troop_get_slot, ":player_renown", "trp_player", slot_troop_renown),
         (store_div, ":renown_decrease", ":player_renown", 500),  # change to 0.2%
